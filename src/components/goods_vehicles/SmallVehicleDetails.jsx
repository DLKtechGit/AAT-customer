...
const SmallVehicleDetails = () => {
  ...
  const images = [
    { image: require("../../assets/Images/small-truck.jpg") },
    { image: require("../../assets/Images/small-truck.jpg") },
    { image: require("../../assets/Images/small-truck.jpg") },
    { image: require("../../assets/Images/small-truck.jpg") },
    { image: require("../../assets/Images/small-truck.jpg") },
  ...
  return (
    <View style={styles.main_container}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Small_main")}
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.main_details_container}>
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                <Text style={styles.vehicle_name_txt}>Tata</Text>
                <Text style={styles.seat_txt}>Ton {""} : 500 kg</Text>
                <Text style={styles.seat_txt}>Size : 5ft × 4ft × 5ft</Text>
              </View>
              <View>
                <Image
                  source={require("../../assets/Images/small-truck.jpg")}
                  style={styles.img}
                />
              </View>
            </View>
          ...
          <View style={styles.fourth_details_container}>
            ...
            <View style={styles.details_main_container}>
              ...
              <View style={styles.info_container}>
                  ...
                  {/* vehicle Size */}
                  <Text style={styles.info_txt}>-  5ft × 4ft × 5ft</Text>
                  {/* Ton detail */}
                  <Text style={styles.info_txt}>-  500 kg</Text>
                  {/* Mileage */}
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("SmallBookingsDetails")}
          >
...
export default SmallVehicleDetails;
