  ...
  return (
    <View style={styles.main_container}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("Medium_main")}
      >
      ...
      <View style={styles.content_container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.main_details_container}>
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                ...
                <Text style={styles.seat_txt}>Ton {""} : 750 kg</Text>
                <Text style={styles.seat_txt}>Size : 7ft × 4ft × 5ft</Text>
              </View>
              <View>
                <Image
          ...
          <View style={styles.fourth_details_container}>
            ...
            <View style={styles.details_main_container}>
              ...
              <View style={styles.info_container}>
                    ...
                    {/* vehicle Size */}
                    <Text style={styles.info_txt}>-  7ft × 4ft × 5ft</Text>
                    {/* Ton detail */}
                    <Text style={styles.info_txt}>-  750 kg</Text>
                    {/* Mileage */}
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("MediumBookingsDetails")}
          >
...
export default MediumVehicleDetails;
