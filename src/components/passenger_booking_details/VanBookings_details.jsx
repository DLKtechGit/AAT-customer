  ...
  return (
    <View style={styles.main_container}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("VanDetails")}
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.main_details_container}>
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                <Text style={styles.vehicle_name_txt}>Force</Text>
                <Text style={styles.seat_txt}>14 seats</Text>
              </View>
            </View>
          </View>
            ...
            {details && (
              ...
              >
                ...
                <View style={styles.info_container}>
                    ...
                    {/* vehicle Color */}
                    <Text style={styles.info_txt}>-  White</Text>
                    {/* Number of Seats */}
                    <Text style={styles.info_txt}>-  14</Text>
                    {/* Mileage */}
          ...
          <View style={styles.booking_details_container}>
            ...
            <View style={styles.details_main_container}>
              ...
              <View style={styles.info_container}>
                    ...
                    {/* cost per km text */}
                    <Text style={styles.booking_info_txt}>-  ₹25 </Text>
                    {/* total amount text*/}
                    <Text style={styles.booking_info_txt}>-  ₹12500</Text>
                    {/* advance text */}
                    <Text style={styles.booking_info_txt}>-  ₹500</Text>
                    {/* balance text */}
                    <Text style={styles.booking_info_txt}>-  ₹12000</Text>                  
                  </View>
            </View>
          </View>
          {/* confirmation button */}
...
export default VanBookings_details;
