  ...
  return (
    <View style={styles.main_container}>
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SmallVehicle_details")}
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.main_details_container}>
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                <Text style={styles.vehicle_name_txt}>3 wheeler</Text>
                <Text style={styles.seat_txt}>Ton : 500kg</Text>
              </View>
            </View>
          </View>
            ...
            {details && (
              ...
              >
                ...
                <View style={styles.info_container}>
                    ...
                    {/* vehicle ton */}
                    <Text style={styles.info_txt}>-  500kg</Text>
                    {/* Number of Seats */}
...
export default SmallBookings_details;
