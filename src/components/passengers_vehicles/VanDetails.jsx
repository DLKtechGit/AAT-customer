...
const VanDetails = ({ route }) => {
  ...
  useEffect(() => {
    getcustomerData()
    const image = vanDetails.vehicleDetails.vehicleImages;
    setImages(image);
  }, []);
  ...
  const handleBookVan = async () => {
    try {
      ...
      const res = await AxiosService.post("customer/bookcar", {
        customerId,
        vendorId: vanDetails.vendorId,
        vehicleId: vanDetails.vehicleDetails._id,
    ...
    <View style={styles.main_container}>
      ...
      <View style={styles.content_container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <Text style={styles.heading_txt}>Van Details</Text>
          {/* Vehicle carousel */}
          ...
          <View style={styles.main_details_container}>
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                <Text style={styles.vehicle_name_txt}>
                  {vanDetails.vehicleDetails.vehicleModel}
                </Text>
                <Text style={styles.seat_txt}>
                  {vanDetails.vehicleDetails.numberOfSeats} Seats
                </Text>
              </View>
              <View>
                <Image
            ...
            {/* more details */}
            <View>
              <Text style={styles.desc_heading}>Spacious Van</Text>
          ...
          <View style={styles.fourth_details_container}>
            ...
            <View style={styles.details_main_container}>
              ...
              <View style={styles.info_container}>
                {/* Owner Name */}
                <Text style={styles.info_txt}>-  {vanDetails.vendorName}</Text>
                {/* Owner Phone */}
                <Text style={styles.info_txt}>-  {vanDetails.vendorPhoneNumber}</Text>
                {/* Vehicle Make */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.vehicleMake}</Text>
                {/* Vehicle Model */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.vehicleModel}</Text>
                {/* License Plate Number */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.licensePlate}</Text>
                {/* vehicle Color */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.vehicleColor}</Text>
                {/* Number of Seats */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.numberOfSeats}</Text>
                {/* Mileage */}
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.milage} Kmpl</Text> 
                <Text style={styles.info_txt}>-  {vanDetails.vehicleDetails.fuelType}</Text> 
                <Text style={styles.info_txt}>-  {vanDetails?.vehicleDetails.pricePerKm}</Text>

<Text style={styles.info_txt}>-  {vanDetails?.vehicleDetails.pricePerDay}</Text>
