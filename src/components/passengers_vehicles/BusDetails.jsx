...
const BusDetails = ({ route }) => {
  ...
  const formattedPickUpDate = moment(pickUpDate).format("MMM Do YYYY");

  useEffect(() => {
    getcustomerData()
    const image = busData.vehicleDetails.vehicleImages;
    setImages(image);
  }, []);
  ...
  const handleBookBus = async () => {
    try {
      ...
      const res = await AxiosService.post("customer/bookcar", {
        ...
        vehicleId: busData.vehicleDetails._id,
    ...
    <View style={styles.main_container}>
      ...
      <View style={styles.content_container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <Text style={styles.heading_txt}>Bus Details</Text>
          {/* Vehicle carousel */}
            ...
            <View style={styles.first_details_container}>
              <View style={{ gap: 5 }}>
                <Text style={styles.vehicle_name_txt}>
                  {busData.vehicleDetails.vehicleModel}
                </Text>
                <Text style={styles.seat_txt}>
                  {busData.vehicleDetails.numberOfSeats} seats
                </Text>
              </View>
              <View>
                <Image
          ...
          <View style={styles.fourth_details_container}>
            ...
            <View style={styles.details_main_container}>
              ...
              <View style={styles.label_container}>
                ...
                <Text style={styles.label_txt}>AC</Text>
              ...
              <View style={styles.info_container}>
                {/* Owner Name */}
                <Text style={styles.info_txt}>-  {busData.vendorName}</Text>
                {/* Owner Phone */}
                <Text style={styles.info_txt}>-  {busData.vendorPhoneNumber}</Text>
                {/* Vehicle Make */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.vehicleMake}</Text>
                {/* Vehicle Model */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.vehicleModel}</Text>
                {/* License Plate Number */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.licensePlate}</Text>
                {/* vehicle Color */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.vehicleColor}</Text>
                {/* Number of Seats */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.numberOfSeats}</Text>
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.ac}</Text>


                {/* Mileage */}
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.milage} Kmpl</Text> 
                <Text style={styles.info_txt}>-  {busData.vehicleDetails.fuelType}</Text> 
                <Text style={styles.info_txt}>-  {busData?.vehicleDetails.pricePerKm}</Text>

<Text style={styles.info_txt}>-  {busData?.vehicleDetails.pricePerDay}</Text>
          ...
          >
            {loading?<ActivityIndicator size="small" color={colors.white}/>:<Text style={styles.confirm_btn_txt}>Pay ₹500 & Confirm Now</Text>}
          </TouchableOpacity>
