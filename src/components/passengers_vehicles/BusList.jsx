...
const BusList = ({ busData ,pickUpLocation,returnLocation,pickUpDate,totalKm,tripType,returnDate}) => {
    ...
    return (
      <View style={styles.emptyContainer}>
        <Image
          ...
          alt="search"
        />
        <Text style={styles.emptyText}>Available Buses will appear here</Text>
      </View>
    );
    ...
    <>
      ...
      {busData?.map((data, index) => {
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("BusDetails",{busData:data,pickUpLocation:pickUpLocation,returnLocation:returnLocation,pickUpDate:pickUpDate,totalKm:totalKm,tripType:tripType,returnDate:returnDate})}
        >
          {/* description */}
