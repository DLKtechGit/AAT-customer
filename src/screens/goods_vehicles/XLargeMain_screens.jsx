import {
  ...
  import XLargeVehicleList from "../../components/goods_vehicles/XLargeVehicleList";
import DateTimeSelector from "../../components/DateTimeSelector";
  
  const XLargeMain_screen = () => {
    const navigation = useNavigation();

    const handleDateTime =(DateTime)=>{
      console.log('XL',DateTime);
  ...
  export default XLargeMain_screen;
