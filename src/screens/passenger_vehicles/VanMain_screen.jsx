...
import VanList from "../../components/passengers_vehicles/VanList";
...
import van_view from "../../assets/Images/van_view.png";
...
const VanMain_screen = () => {
  ...
  const getVan = async () => {
    ...
    try {
      ...
      const vandatas = res.data.availableVehicles;
      if (res.status === 200) {
        setVanData(vandatas);
  ...
  const getAllvendor = async () => {
    try {
      ...
      const filteredVendor = data.filter((e) => e.vehicles.vans.length > 0);
